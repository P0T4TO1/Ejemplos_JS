...
function cifrar(){
    ...
    cesar.encode(document.getElementById("cadena").value, parseInt(document.getElementById("numDesp").value));
}
...
function descifrar(){
    ...
    cesar.decode(document.getElementById("cadena").value, parseInt(document.getElementById("numDesp").value));
}